async function main() {
  ...
  bidderVerifierAddress = "0x576939d42BA8d9787fF189a01d9fa5768B11c467";

  let bidderVerifier = await hre.ethers.getContractAt(
    "ERC20Verifier",
    bidderVerifierAddress
  );

  const requestId = await bidderVerifier.TRANSFER_REQUEST_ID();

  try {
    await bidderVerifier.setZKPRequest(requestId, validatorAddress, ageQuery);
